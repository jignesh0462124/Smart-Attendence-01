...
const EmployeeDashboard = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      {/* Sidebar - Fixed width, not constrained */}
      ...
      <main className="flex-1 overflow-auto">
        ...
        {/* Dashboard Content - Constrained to 960px on desktop, 320-375px on mobile */}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-8 mb-6 sm:mb-8">
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                ...
                <div className="flex gap-3 sm:gap-4">
                  <button className="flex-1 sm:flex-none px-4 sm:px-8 py-3 sm:py-4 bg-green-500 hover:bg-green-600 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all flex flex-col items-center">
                    <span className="text-xl sm:text-2xl mb-1">→</span>
                    <span className="text-sm sm:text-base">Clock In</span>
                    <span className="text-xs opacity-90 mt-1">Face Scan</span>
                  </button>
                  <button className="flex-1 sm:flex-none px-4 sm:px-8 py-3 sm:py-4 bg-gray-100 text-gray-400 rounded-xl font-semibold flex flex-col items-center cursor-not-allowed">
                    <span className="text-xl sm:text-2xl mb-1">←</span>
