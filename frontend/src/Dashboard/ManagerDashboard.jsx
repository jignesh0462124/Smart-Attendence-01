...
const ManagerDashboard = () => {
    ...
    const [expandedMenu, setExpandedMenu] = useState(null); // Removed type annotation for null

    const navigate = useNavigate();

    // Removed type annotation for 'menu'
    const toggleMenu = (menu) => setExpandedMenu(prev => (prev === menu ? null : menu));

    // Removed type annotation for 'page' and the Record map
    ...
    // Removed type annotations for function parameters and return types
    ...
    // Mock data (No change needed here as it's just data structure)
    const stats = [
        {
            title: 'Working Days',
            value: '20',
        ...
        <div className="flex min-h-screen bg-gray-50">
                ...
                <div className="p-6 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">MANAGER</p> {/* Changed EMPLOYEE to MANAGER */}
                        </div>
                    </div>
                </div>
                ...
                <div className="p-4 border-t border-gray-200">
                    <Link to="/manager-profile" className="flex items-center space-x-3 mb-3 ">
                        <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-semibold">
                            JM {/* Changed from SJ to JM for John Manager */}
                        </div>
            ...
            <main className="flex-1 overflow-auto">
                ...
                <header className="bg-white border-b border-gray-200 px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h2 className="text-2xl font-bold text-gray-900">Good Morning, John!</h2> {/* Corrected 'jhon' to 'John' */}
